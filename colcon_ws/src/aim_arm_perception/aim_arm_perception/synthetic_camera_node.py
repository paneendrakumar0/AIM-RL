...
class SyntheticCameraNode(Node):
    def __init__(self) -> None:
        ...
        self.moving = bool(self.declare_parameter("moving", True).value)
        self.center_x_ratio = float(self.declare_parameter("center_x_ratio", 0.625).value)
        self.center_y_ratio = float(self.declare_parameter("center_y_ratio", 0.5).value)
    ...
    def publish_frame(self) -> None:
        ...
        if self.moving:
            ...
            center_x = int(self.width * self.center_x_ratio)
        center_y = int(self.height * self.center_y_ratio)
