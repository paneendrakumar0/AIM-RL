...
- Optional ROS 2 control and MoveIt configuration validates statically.
...
- Add an RViz MotionPlanning display configuration and a plan-execution smoke test once MoveIt 2 is installed.
